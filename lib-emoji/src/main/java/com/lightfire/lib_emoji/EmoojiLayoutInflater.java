...
class EmoojiLayoutInflater extends LayoutInflater {
    ...
    protected EmoojiLayoutInflater(LayoutInflater original, Context newContext) {
        super(original, newContext);
        setUpLayoutFactories(false);
    }

    protected EmoojiLayoutInflater(LayoutInflater original, Context newContext, final boolean cloned) {
        super(original, newContext);
    ...
    public LayoutInflater cloneInContext(Context newContext) {
        return new EmoojiLayoutInflater(this, newContext, true);
    }
...
//        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Emooji);
//        boolean useEmojix = a.getBoolean(R.styleable.Emojix_emoji, true);
//        a.recycle();

        Emooji.wrapView(view);
    ...
    private static class BaseFactory {
        ...
        protected View createView(EmoojiLayoutInflater inflater, String name, Context context, AttributeSet attrs) {
            View view = null;
    ...
    private static class WrapperFactory extends BaseFactory implements Factory {
        ...
        private final EmoojiLayoutInflater inflater;

        public WrapperFactory(Factory factory, EmoojiLayoutInflater inflater) {
    ...
    private static class WrapperFactory2 extends BaseFactory implements Factory2 {
        ...
        protected final EmoojiLayoutInflater inflater;

        public WrapperFactory2(Factory2 factory2, EmoojiLayoutInflater inflater) {
